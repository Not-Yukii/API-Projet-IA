...
def answer_with_memory(question: str, conversation_id: int, k_mem: int = 5, k_docs: int = 40, file_names: List[str] | None = None, texts_from_files: List[str] | None = None) -> str:
    ...
    prompt = (
        ...
        ### Imperative rules
            - Answer in French except if the user is using another language.
